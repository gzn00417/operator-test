...
class OperatorTestCase(unittest.TestCase):
    ...
    def result_write_to_file(self, result, file_name):
        f = open("./results/%s" % file_name, "w")
        f.write(str(result))
    ...
    def test(self):
        ...
        self.assertTrue(
            filecmp.cmp(
                "./results/%sResult.txt" % self.__class__.__name__,
                "./answers/%sAnswer.txt" % self.__class__.__name__,
            )
        )
